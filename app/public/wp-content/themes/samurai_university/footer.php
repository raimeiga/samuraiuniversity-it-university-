              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_section footer_about">
                  <div class="footer_logo_container">
                    ...
                    <a href="">
                      <div class="footer_logo_text">IT★University</div>
                    </a>
                  </div>
                  ...
                  <div class="footer_contact_info">
                    ...
                    <ul>
                      ...
                      <li><span>MAIL: </span>: it-university@example.com</li>
                    </ul>
                  </div>
                ...
                <div class="footer_section footer_links">
                  <div class="footer_links_container">
                    <ul>
                      ...
                      <li><a href="<?php echo home_url(); ?>/about">IT★大学について</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-lg-5 footer_col clearfix">
                <a class="twitter-timeline" data-height="265" href="https://twitter.com/samuraijuku?ref_src=twsrc%5Etfw">Tweets by IT★juku</a>
      ...
      <div class="row copyright_row">
        <div class="col">
          <div class="copyright d-flex flex-lg-row flex-column align-items-center justify-content-start">
            <div class="cr_text">
              Copyright &copy; IT★University All Rights Reserved.
            </div>
          </div>
        </div>
      </div>
